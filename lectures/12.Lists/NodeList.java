...
public class NodeList<T> implements List<T> {
    ...
    public static void main(String[] args) {
      ...
      System.out.println("insertFront: Mike");
      Position a = l.insertFront("Mike");
      System.out.println(l);

      System.out.println("insertBack: Peter");
      Position b = l.insertBack("Peter");
      System.out.println(l);

      System.out.println("insertFront: Kelly");
      Position c = l.insertFront("Kelly");
      System.out.println(l);

      System.out.println("remove a (Mike)");
      l.remove(a);
      System.out.println(l);

      System.out.println("insertBack: James");
      l.insertBack("James");
      System.out.println(l);

      System.out.println("Print using forward iterator");
      Iterator<String> fit = l.forward();
      while (fit.hasNext()) {
        System.out.println(fit.next());
      }

      System.out.println("Print using backward iterator");
      Iterator<String> bit = l.backward();
      while (bit.hasNext()) {
